...
const app: Record<SupportedChains, AppConfig> = {
  [ChainId.Rinkeby]: {
    ...
    subgraphApiUri: 'https://api.studio.thegraph.com/query/30189/proper-nouns-subgraph/v0.0.1',
    enableHistory: process.env.REACT_APP_ENABLE_HISTORY === 'true',
  },
  [ChainId.Mainnet]: {
    jsonRpcUri: createNetworkHttpUrl('mainnet'),
    wsRpcUri: createNetworkWsUrl('mainnet'),
    subgraphApiUri: 'https://api.thegraph.com/subgraphs/name/propernounsdao/propernouns-subgraph',
    enableHistory: process.env.REACT_APP_ENABLE_HISTORY === 'true',
  },
  [ChainId.Hardhat]: {
